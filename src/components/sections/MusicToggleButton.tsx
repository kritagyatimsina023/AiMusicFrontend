...
const Skiper25 = () => {
  return (
    <div className="flex h-full w-full bg-amber-300/10 flex-col items-center justify-center">
      <div className="text-foreground  grid content-start justify-items-center gap-6 py-20 text-center">
        <span className="after:from-background after:to-foreground relative max-w-[12ch] text-xs uppercase leading-tight opacity-40 after:absolute after:left-1/2 after:top-full  after:w-px after:bg-gradient-to-b after:content-['']">
