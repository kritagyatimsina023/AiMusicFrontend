...
const Developer = () => {
  ...
  // const;
  return (
    <div className="h-screen  relative  mx-auto flex justify-center items-center">
      <img
      ...
      <div className="absolute top-[20%] left-[10%] h-0 w-[28rem] opacity-50  shadow-[0_0_900px_10px_#e99b63] rotate-[30deg] " />
      <div className="absolute top-[20%] right-[10%] h-0 w-[28rem] opacity-50  shadow-[0_0_900px_10px_#e99b63] -rotate-[30deg] " />
